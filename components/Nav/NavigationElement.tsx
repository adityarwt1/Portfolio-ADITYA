...
const NavigationElement:React.FC<Role>  = ({role, isAdmin})=>{
    return (
      <div className="flex w-full justify-center">
        ...
        <Link href="/components" className="mx-2 animate hover:border-b duration-300 transition-all hover:bg-white/15  p-2  shadow-2xs shadow-white  ">Components</Link>
        ...
        {isAdmin?<Link href="/admin" className="mx-2  hover:border-b duration-300 transition-all hover:bg-white/15 p-2   shadow-2xs shadow-white  ">Admin</Link>:""}
